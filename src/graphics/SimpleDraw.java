...
/** Displays a window and delegates drawing to graphics.DrawGraphics. */
public class SimpleDraw extends JPanel implements Runnable {
    ...
    public static void main(String args[]) {
        ...
        final SimpleDraw content1 = new SimpleDraw(new DrawGraphics());
//        final SimpleDraw content2 = new SimpleDraw(new DrawGraphics(new ArrayList<BouncingBox>(Arrays.asList(
//                new BouncingBox(150, 50, Color.RED),
//                new BouncingBox(10, 10, Color.BLUE),
...
//        ))));
        ...
        content1.setBackground(bgColor);
//        content.setSize(WIDTH, HEIGHT);
//        content.setMinimumSize(new Dimension(WIDTH, HEIGHT));
        content1.setPreferredSize(new Dimension(WIDTH, HEIGHT));
//        frame.setSize(WIDTH, HEIGHT);
        ...
        frame.addWindowListener(new WindowAdapter() {
            ...
            public void windowDeiconified(WindowEvent e) { content1.start(); }
            public void windowIconified(WindowEvent e) { content1.stop(); }
        });

        new Thread(content1).start();
//        new Thread(content2).start();
